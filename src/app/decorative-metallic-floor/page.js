...
const sections = [
  {
    ...
    title: "Redefining Reliability: Metal Coatings Tampa, Florida Aerospace",
    description: (
      <div style={{ whiteSpace: "pre-line" }}>
        <div style={{ marginBottom: "1rem" }}>
          Unprotected concrete can leave your home or business exposed to safety
          hazards such as slips, falls, and grooves that prevent locomotive
          movement across the surface. Furthermore, the metallic coating should
          be decorated in order to keep your safety and class intact. The best
          way to protect yourself and the posh is with quality Decorative
          Metallic Coating.
        </div>

        <div style={{ marginBottom: "1rem" }}>
          Metal epoxy floors are a great solution for garages and basements
          because they have waterproof, non-slip, and anti-microbial properties.
          Transform your garage or basement with premium metallic epoxy coatings
          and take any workspace to a new level of low maintenance,
          anti-microbial and waterproof. The advantage of metal epoxy floors is
          the long-lasting protection of residential and commercial surfaces and
          the special composition that ensures that you are prepared for the
          impacts and changes of the environment. With years of professional
          experience and highly skilled craftsmanship, we are able to provide
          unmatched Metal Floor Coatings Tampa, Florida.
        </div>
        <div style={{ marginBottom: "1rem" }}>
          We Also Provide Patio Coating, Concrete Coating, Driveway Coating,
          Pool Deck Coating, Commercial Coating and Metal Floor Coating.
        </div>
      </div>
    ),
    imgSrc: "/images/metallic-flooring-system-500x500-1.webp",
  },
];
      ...
      <div className="relative min-h-[60vh] bg-gradient-to-r from-green-500 to-black bg-center bg-no-repeat bg-cover z-0">
        ...
        <div className="relative z-10 p-10 w-full text-center">
          <h1 className="text-white mt-32 text-5xl font-bold">
            Decorative Metallic Floor Coating in Tampa, Florida
          </h1>
