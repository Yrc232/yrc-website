...
const sections = [
  {
    ...
    title:
      "Enhancing Durability and Beauty of Home: Concrete Coating Tampa, FL",
    description: (
      <div style={{ whiteSpace: "pre-line" }}>
        <div style={{ marginBottom: "1rem" }}>
        Long Life Concrete coatings are a cost-effective renovation project that can spruce up your home in a day. Whether you are looking to repair damaged concrete or remodel your commercial or residential property
        </div>

        <div style={{ marginBottom: "1rem" }}>
        we are located in Tampa, Florida, and proudly serve communities in the area. We put your safety first and are committed to increasing the durability of your concrete floor with a waterproof coating. We know how difficult it can be to protect your floors from fading in the sun and prevent moisture damage from our constant humidity. With years of professional experience and highly skilled craftsmanship, we are submitted to deliver the Long Lasting  Concrete Coatings  Company Near Tampa, Florida. We Also Provide Patio Coating, Driveway Coating, Pool Deck Coating, Commercial Coating and Metal Floor Coating.
        </div>
      </div>
    ),
    imgSrc: "/images/flooring-in-tampa-fl.webp",
  },
];
...
Concrete Coating in Tampa, Florida
          </h1>
