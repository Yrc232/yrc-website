...
const sections = [
  {
    ...
    title:
      "Patio Coating Tampa - Revamp Your Outdoor Space with Stunning Patio Coatings Tampa",
    description: (
      <div style={{ whiteSpace: "pre-line" }}>
        <div style={{ marginBottom: "1rem" }}>
          Outdoor patios are exposed to influences such as heat, weather, and
          traffic that can compromise them over time. In Florida, the biggest
          enemies of our homes are the constant, unrelenting sun and
          catastrophic hurricanes.
        </div>

        <div style={{ marginBottom: "1rem" }}>
          The best way to stay out of the elements is to protect outdoor floor
          surfaces with quality concrete coatings in Tampa. At Performance
          Floors and Coating, we deal in UV-stable, polyaspartic coatings that
          are four times more durable than traditional epoxy floors. Our experts
          will provide preliminary cost estimates for each project, and we can
          have your affordable patio coating wholly installed in one day. With
          years of professional experience and highly skilled craftsmanship, we
          are submitted to deliver the best and cheap Patio Coatings Tampa. We
          Also Provide Patio Coating, Concrete Coating, Driveway Coating, Pool
          Deck Coating, Commercial Coating and Metal Floor Coating.
        </div>
      </div>
    ),
    imgSrc: "/images/tampa-flooring-1.webp",
  },
];
      ...
      <div className="relative min-h-[60vh] bg-gradient-to-r from-green-500 to-black bg-center bg-no-repeat bg-cover z-0">
        ...
        <div className="relative z-10 p-10 w-full text-center">
          <h1 className="text-white mt-32 text-5xl font-bold">
            Best Patio Coating in Tampa, Florida
          </h1>
