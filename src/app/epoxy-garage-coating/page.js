...
const sections = [
  {
    ...
    title: "Florida Finest: Garage Epoxy Floor Coatings for Lasting Durability",
    description: (
      <div style={{ whiteSpace: "pre-line" }}>
        <div style={{ marginBottom: "1rem" }}>
          With years of experience in business, YRC is an unparalleled leader in
          the installation of the high-performance epoxy floor in your garages.
          Epoxy floor systems are used to resurface concrete floors and add
          color to mark sidewalks or other signs
        </div>

        <div style={{ marginBottom: "1rem" }}>
          They also provide a number of performances. Features, such as slip
          resistance, chemical resistance, and abrasion resistance. Epoxy floors
          are also used to provide waterproofing and a slope for drainage, and
          are a seamless solution to sanitary protection. Aesthetically, epoxy
          floors can add a decorative finish and design to commercial and
          industrial spaces with unlimited color options. With years of
          professional experience and highly skilled craftsmanship, we are able
          to provide unparalleled Epoxy Floor Coating near Tampa, Florida. We
          Also Provide Patio Coating, Concrete Coating, Driveway Coating, Pool
          Deck Coating, Commercial Coating and Metal Floor Coating.
        </div>
      </div>
    ),
    imgSrc: "/images/Epoxy-Garage-Floor-Hero.webp",
  },
];
      ...
      <div className="relative min-h-[60vh] bg-gradient-to-r from-green-500 to-black bg-center bg-no-repeat bg-cover z-0">
        ...
        <div className="relative z-10 p-10 w-full text-center">
          <h1 className="text-white mt-32 text-5xl font-bold">
            Professional Epoxy Garage Floor Coating Company in Tampa, FL
          </h1>
