...
const sections = [
  {
    ...
    title:
      "YRC Takes Pride in Presenting Polyaspartic Garage Coating to Lift up the Style of Your Premises",
    description: (
      <div style={{ whiteSpace: "pre-line" }}>
        <div style={{ marginBottom: "1rem" }}>
          The polyurea-polyaspartic coating protects your garage surface for
          years with proper maintenance and care. However, unlike its epoxy or
          quartz counterparts, polyurea polyaspartic requires much less
          maintenance and care to keep utility alive..
        </div>

        <div style={{ marginBottom: "1rem" }}>
          It takes patience, skill, and special tools to bring your Polyaspartic
          Garage Coating in Tampa into reality; however, we are ready for your
          demands to get fulfilled. Here at YRC Custom Flooring, we specialise
          in Polyaspartic Garage Coating. We offer premium garage coating that
          is resistant to chemicals and damage, as well as moisture vapour
          management and electrostatic dissipative (ESD). Our coating is
          characterized as tough, keeping equilibrium with beauty and modern
          styles. We use high-quality protective layers, which can be used in
          applications wherever heavy surface wear and corrosion are expected.
          With years of professional experience and highly skilled
          craftsmanship, we are submitted to deliver peerless Polyaspartic
          Garage Coating services in Tampa. We Also Provide Patio Coating,
          Concrete Coating, Driveway Coating, Pool Deck Coating, Commercial
          Coating and Metal Floor Coating.
        </div>
        <div style={{ marginBottom: "1rem" }}></div>
      </div>
    ),
    imgSrc: "/images/rmorclad-4.webp",
  },
];
      ...
      <div className="relative min-h-[60vh] bg-gradient-to-r from-green-500 to-black bg-center bg-no-repeat bg-cover z-0">
        ...
        <div className="relative z-10 p-10 w-full text-center">
          <h1 className="text-white mt-32 text-5xl font-bold">
            Polyaspartic Garage Floor Coating Company in Tampa, Florida
          </h1>
