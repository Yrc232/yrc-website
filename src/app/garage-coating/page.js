...
const sections = [
  {
    ...
    title:
      "Enhance Your Garage's Durability with Polyaspartic Coating Tampa, Florida",
    description: (
      <div style={{ whiteSpace: "pre-line" }}>
        <div style={{ marginBottom: "1rem" }}>
          With years of experience in business, YRC is an unparalleled leader in
          the installation of high-performance epoxy floor in your garages.
          Epoxy floor systems are used to resurface concrete floors and add
          colour to mark sidewalks or other signs.
        </div>

        <div style={{ marginBottom: "1rem" }}>
          They also provide a number of performance features such as slip
          resistance, chemical resistance and abrasion resistance. Epoxy Garage
          coating in tampa are also used to provide waterproofing and a slope
          for drainage and are a seamless solution to sanitary protection.
          Aesthetically, epoxy Garage floors coating in tampa can add a
          decorative finish and design to commercial and industrial spaces with
          unlimited colour options. With years of professional experience and
          highly skilled craftsmanship, we are able to provide unparalleled
          garage floor Coating services in Tampa. We Also Provide Patio Coating,
          Pool Deck Coating, Driveway Coating, Commercial Coating, Concrete
          Coating, and Metal Floor Coating.
        </div>
      </div>
    ),
    imgSrc: "/images/floor-decor-tampa.webp",
  },
];
      ...
      <div className="relative min-h-[60vh] bg-gradient-to-r from-green-500 to-black bg-center bg-no-repeat bg-cover z-0">
        ...
        <div className="relative z-10 p-10 w-full text-center">
          <h1 className="text-white mt-32 text-5xl font-bold">
            Garage Floor Coatings in Tampa, Florida
          </h1>
