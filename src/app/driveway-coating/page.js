...
const sections = [
  {
    ...
    title:
      "Protect and Impress: Discover the Benefits of Driveway Coating Tampa, Florida",
    description: (
      <div style={{ whiteSpace: "pre-line" }}>
        <div style={{ marginBottom: "1rem" }}>
          When it comes to renovating the exterior of your home or business, you
          may not initially think about improving your driveway. However, our
          driveways are often the outdoor area that suffers the most damage. But
          it’s out of sight and out of mind.
        </div>

        <div style={{ marginBottom: "1rem" }}>
          Whether you’re thinking about selling your home soon or trying to
          increase the security of your work area, painting your driveway can go
          a long way in making it look better as well as providing preventative
          protection. Sealing your driveway not only increases your property’s
          resale value, but a polyaspartic coating protects the surface for
          decades with proper maintenance and care. However, unlike its epoxy or
          quartz counterparts, polyuria-polyaspartic requires much less
          specialized care to maintain its beneficial properties. With years of
          professional experience and highly skilled craftsmanship, we are able
          to provide unparalleled Concrete Driveway Coating Tampa, Florida. We
          Also Provide Patio Coating, Concrete Coating, Driveway Coating, Pool
          Deck Coating, Commercial Coating and Metal Floor Coating.
        </div>
      </div>
    ),
    imgSrc: "/images/driveway-coating.webp",
  },
];
      ...
      <div className="relative min-h-[60vh] bg-gradient-to-r from-green-500 to-black bg-center bg-no-repeat bg-cover z-0">
        ...
        <div className="relative z-10 p-10 w-full text-center">
          <h1 className="text-white mt-32 text-5xl font-bold">
            Driveway Floor Coating in Tampa, Florida
          </h1>
