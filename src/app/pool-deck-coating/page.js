...
const sections = [
  {
    ...
    title:
      "Making a Splash: Transform Your Pool Deck with Coatings Tampa FL",
    description: (
      <div style={{ whiteSpace: "pre-line" }}>
        <div style={{ marginBottom: "1rem" }}>
          Pool deck resurfacing removes old concrete and makes way for smooth,
          brand-new coatings that attract the eye and prevent risk. With
          professional installation, several problems, such as oil compaction,
          spalling, heaving, broken concrete, concrete overheating, and moisture
          damage, need to be solved as soon as possible
        </div>

        <div style={{ marginBottom: "1rem" }}>
          These are threats to your safety and your enjoyment. Pool deck
          resurfacing in Tampa will reinforce the concrete with a UV-stable
          polyaspartic coating that is abrasion, chemical, chip, and stain
          resistant. We know how easy it is for an outdoor floor to take a
          beating. Prevent damage with a quality polyaspartic coating that is
          impact resistant and will retain its like-new quality for up to
          fifteen years. With years of professional experience and highly
          skilled craftsmanship, we are able to provide the Best Pool Deck
          Coating in Tampa. We Also Provide Patio Coating, Concrete Coating,
          Driveway Coating, Pool Deck Coating, Commercial Coating and Metal
          Floor Coating.
        </div>
      </div>
    ),
    imgSrc: "/images/pool.webp",
  },
];
      ...
      <div className="relative min-h-[60vh] bg-gradient-to-r from-green-500 to-black bg-center bg-no-repeat bg-cover z-0">
        ...
        <div className="relative z-10 p-10 w-full text-center">
          <h1 className="text-white mt-32 text-5xl font-bold">
            Cool Pool Deck Coating in Tampa, FL
          </h1>
